...
const PROFILE_DIR = path.join(PROJECT_ROOT, 'data/wechat-channels-profile')
const CDP_PORT = process.env.WECHAT_CHANNELS_CDP_PORT || '9222'
const START_URL = process.env.WECHAT_CHANNELS_START_URL || 'https://channels.weixin.qq.com/platform/post/create'
const WINDOW_WIDTH = process.env.WECHAT_CHANNELS_WINDOW_WIDTH || '1400'
const WINDOW_HEIGHT = process.env.WECHAT_CHANNELS_WINDOW_HEIGHT || '860'
