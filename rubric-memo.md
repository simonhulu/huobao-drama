...
### 2026-07-17 太平天国最早的裂（3eada99cd5c2）— 高于基线但传播与留存分离

- 预测：composite=8.00，bucket=`183-549`，预测中枢约 320。
- 实绩：T+3d 播放 1309，点赞 30，评论 4，收藏 4，分享 0；点赞率 2.29%，评论率 0.31%，收藏率 0.31%，分享率 0%。
- 观看信号：平均播放 31.2 秒，平均播放占比 4.82%，2 秒跳出率 43.36%，5 秒完播率 27.66%，完播率 2.46%。
- 评论信号：可见 3 条（作品指标为 4 条，另 1 条未被接口暴露），分别表现为追更期待、主题复述、历史因果讨论；样本不足，不作高赞模因结论。
- 判断：HP=5 + NA=5 的历史权力冲突入口支持播放达到 1309，但未带来分享；长时长、首屏表达和前段留存仍是主要限制。该观察目前只有 1 个样本，不直接修改 rubric。
- 详见：[predictions/2026-07-14_3eada99cd5c_太平天国最早的裂.md](predictions/2026-07-14_3eada99cd5c_太平天国最早的裂.md)
